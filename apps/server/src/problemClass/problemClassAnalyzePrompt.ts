...
const FORBIDDEN_CMD_RE = /\b(rm|mv|cp|chmod|chown|kill|curl|wget|ssh|scp|npm|pnpm|yarn|pip|push|commit|reset|checkout|merge|rebase|apply|clean|sudo|tee|eval|exec)\b|[`$()<>|&;]|\s-(delete|exec(dir)?|ok(dir)?|fprintf?|fprint0|fls)\b/;
